...
const NAVIGATION = [
  { key: 'Homepage', title: '首页', label: '首页', icon: () => h(MailOutlined), router: { name: 'Homepage' } },
  ...
  { key: 'Publications', title: '研究成果', label: '研究成果', icon: () => h(MailOutlined), router: { name: ' Publications' } },
